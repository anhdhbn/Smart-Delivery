...
namespace SmartDelivery
{
    public class AuthenticationFilter : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext FilterContext)
        {
            ...
            if (checkAuth(request.Path.Value))
                return;
            if (request.Path.Value == "/api/User" && request.Method == "POST")
                return;
            ...
            if (JWTEntity != null)
            {
                ...
                //{
                //    FilterContext.Result = new ContentResult() { Content = "{\"success\":false, \"message\":\"Cookie has expired\"}" ,ContentType = "application/json", StatusCode = 401};
                //    return;
                //}
            ...
            else
            {
                ...
                {
                    FilterContext.Result = new ContentResult() { Content = "{\"success\":false, \"message\":\"Auth failed\"}", ContentType = "application/json", StatusCode = 401 };
                }
                else
        ...
        {
            List<string> list = new List<string>() { "/", "/api/User/Login", "/api/Test", "/api/Scale"};
            List<string> list2 = new List<string>() { "/api/Scale" , "/api"};
    ...
    public class JWTEntity
    {
        ...
        public DateTime ExpTime
        {
            get
            {
                ...
                dtDateTime = dtDateTime.AddSeconds(long.Parse(exp));
                return dtDateTime;
            }
        }
    ...
    public interface IJWTHandler : ITransientService
    {
        ...
        string CreateToken(UserEntity UserEntity, DateTime expires);
    }
  ...
  <Exponent>AQAB</Exponent>
    ...
    <D></D>
            ...
            try
            {
                ...
                if (verify)
                {
                    ...
                    if (rsaDeformatter.VerifySignature(hash, Base64UrlDecode(parts[2])))
                    {
                        ...
                        if (JWTEntity.ExpTime < DateTime.UtcNow)
                        {
                            return null;
        ...
        public string CreateToken(UserEntity UserEntity, DateTime expires)
        {
